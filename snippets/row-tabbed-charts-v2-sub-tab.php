...
$cache_key = 'charts_v2_sub' . $id . $chart_sub_table_name;
$charts = InsiteModel::cache_get($cache_key);
if (!$charts) {
    // Define our charts array
    $charts = array();
    if ($chart_records = $page->page_type_table_records($chart_sub_table_name)) {
...
?>
<div class="content-box tabs-box sub-tabs" data-row="<?= $id; ?>">
